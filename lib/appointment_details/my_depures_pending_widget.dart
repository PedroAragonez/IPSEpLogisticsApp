...
class DepuresWidget extends StatefulWidget {
  const DepuresWidget({Key key, }) : super(key: key);

  @override
  _DepuresWidgetState createState() => _DepuresWidgetState();
}

class _DepuresWidgetState extends State<DepuresWidget> {
  final scaffoldKey = GlobalKey<ScaffoldState>();
  List<numOrder> listadeOrdenes = [];
  @override
  void initState() {
    super.initState();
  ...
  _getRequisitorEventos() async {
    DatabaseProvider.getSalidasNumorder().then((value) {
      setState(() {
        print(value.first.orderNum);
